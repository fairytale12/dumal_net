  ...
  <aside class="sidebar clearfix">
    ...
    <div class="widget author-widget">
      <div class="author-thumb">
        <a href="page_author.html">
          <img src="http://placehold.it/141x141" alt="">
        </a>
      </div>
      <div class="author-meta">
        <h3 class="author-title">
          <a href="page_author.html">John Doe</a>
        </h3>
        <p class="author-position">Chief editor</p>
        <p class="author-bio">He is here. All right. Well, take care of yourself, Han. I guess that's what you're best at, ain't it? What?! Don't act so surprised, Your Highness. You weren't on any mercy mission this time.</p>
    ...
    <div class="widget tabwidget">
      <ul class="nav nav-tabs" role="tablist" id="widget-tab">
        ...
        <li role="presentation"><a href="#tab-comments" aria-controls="tab-comments" role="tab" data-toggle="tab">Comments</a></li>
      </ul>
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active animated fadeIn" id="tab-popular">
          ...
          <article class="widget-post clearfix">  
            <div class="simple-thumb">
              <a href="#">
                <img src="http://placehold.it/95x80" alt="">
              </a>
            </div>
            <header>
              <h3>
          ...
          <article class="widget-post clearfix">  
            ...
            <header>
              <h3>
                <a href="#">9 Apps for Transforming Your Phone into The Ultimate Toolkit</a>
              </h3>
              <p class="simple-share">
          ...
          <article class="widget-post clearfix">  
            ...
            <header>
              <h3>
                <a href="#">15 Books You Should Read Before They Become Movies This Year</a>
              </h3>
              <p class="simple-share">
          ...
          <article class="widget-post clearfix">  
            ...
            <header>
              <h3>
                <a href="#">The 20 most important Instagram pictures of all time</a>
              </h3>
              <p class="simple-share">
        ...
        <div role="tabpanel" class="tab-pane animated fadeIn" id="tab-recent">
          ...
          <article class="widget-post clearfix">  
            ...
            <header>
              <h3>
                <a href="#">7 Tips for Creating a Functional Home Workspace</a>
              </h3>
              <p class="simple-share">
        ...
        <div role="tabpanel" class="tab-pane animated fadeIn" id="tab-comments">
